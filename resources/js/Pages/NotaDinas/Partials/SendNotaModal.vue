    ...
    <div class="bg-white rounded-lg shadow-xl w-11/12 max-w-3xl p-6 relative">
      ...
      <form @submit.prevent="handleSubmit">
        <div class="mb-4">
          ...
          <textarea v-model="form.catatan" rows="3" class="w-full border-gray-300 rounded-md shadow-sm px-3 py-2"></textarea>
        </div>

        <div v-if="showLampiran" class="mb-4">
          <label class="block text-sm font-medium text-gray-700 mb-1">Lampiran bisa lebih dari 1 (opsional)</label>
        ...
        <div class="flex justify-end gap-2">
          <button type="button" @click="closeSendModal" class="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400">Batal</button>
          <button
            type="submit"
