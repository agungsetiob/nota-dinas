...
<template>
  <div class="min-h-screen bg-pattern flex flex-col">
    ...
    <div class="flex-1 pt-16 pb-12 sm:pt-16 sm:pb-0 relative">
      <div v-if="isLoading" class="fixed inset-0 flex items-center justify-center bg-pattern z-10"
      :style="{
          top: '4rem',
          bottom: '0rem',
        ...
        <svg class="animate-spin h-20 w-20 text-black-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
